      ...
      <PageLayout>
        ...
        <PageContent>
          <div className="space-y-6 text-base leading-relaxed text-gray-800">
            <p>
              Hello! I&rsquo;m Vijay, a professional <strong>freelance web developer</strong> based in India with
              extensive experience in building websites and applications using technologies like{' '}
              <strong>WordPress</strong>, <strong>WooCommerce</strong>, and <strong>Next.js</strong>. I collaborate
              remotely with clients from around the world to deliver clean, efficient, and scalable web solutions.
            </p>

            <p>
              If you find the tools on this site useful, I&rsquo;d love to hear your feedback or suggestions for new
              features. Whether you&rsquo;re a developer, content creator, student, or business owner, your input helps
              me improve and expand the platform to better serve your needs.
            </p>

            <p>
              This entire website is open-source and publicly available on GitHub. If you&rsquo;re curious about how
              it&rsquo;s built, want to contribute code, report bugs, or suggest enhancements, feel free to explore the
              repository below. Open-source collaboration is at the heart of what I do, and I welcome developers of all
              skill levels to get involved.
            </p>
            ...
            <p>
              Beyond building these tools, I&rsquo;m available for freelance work, specializing in WordPress website
              development, WooCommerce online stores, and modern React-based web applications using Next.js. I&rsquo;m
            ...
            <p>
              ...
              PeoplePerHour - a trusted freelance platform where I&rsquo;ve successfully completed numerous client
              projects.
            </p>
            ...
            <p>
              I&rsquo;m also active on various social media platforms where I share updates, tips, and engage with the
            ...
            <p>
              Thank you for visiting my site. I hope these tools help streamline your workflow and make your web
              projects easier. Whether you want to contribute to the codebase, hire me for a project, or just say hello,
              I&rsquo;m always excited to connect with new people.
            </p>

            <p>
              For any questions or inquiries not covered here, you can also send me a direct message on any of the
              social platforms above, or email me through the contact form (if available). I aim to respond promptly and
