    ...
    <WithInfoPage slug="contact" schemaType="contact">
      <div className="space-y-6 text-base leading-relaxed text-gray-800">
        ...
        <p>
          ...
          features. Whether you&rsquo;re a developer, content creator, student, or business owner, your input helps me
          improve and expand the platform to better serve your needs.
        </p>
