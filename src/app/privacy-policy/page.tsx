 ...
 *
 */
export const metadata: Metadata = getInfoPageMetadata('privacy-policy');
...
export default withInfoPage({
  ...
  children: (
    <div className="space-y-6 text-base leading-relaxed text-gray-800">
      ...
      <p>
        At <strong>Tools by Vijay</strong> (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), your privacy is a top
        priority. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you
      ...
      <p>
        ...
        do not agree with any part of this policy, please discontinue use of our services.
      </p>
      ...
      <p>
        When you visit our website, certain non-personally identifiable information is automatically collected through
      ...
      <ul className="list-disc space-y-1 pl-6">
        <li>
          ...
          anonymized data about page views, session duration, browser type, device type, and general geographic location
          (country/city level). This data is collected via cookies and similar tracking technologies. Your IP address is
          anonymized before processing. Google Analytics helps us understand how visitors use the site so we can improve
      ...
      <p>
        <strong>We do not collect, store, or log any data you enter into our tools.</strong> Here is how your data is
        handled depending on the tool type:
      </p>

      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>Client-side tools</strong> (Slug Generator, Character Counter, Password Checker, Text Case Changer, QR
          Code Generator, JSON Sorter, and most text utilities) — All processing happens entirely in your browser using
          JavaScript. Your data never leaves your device and is not transmitted to any server.
        </li>
        <li>
          <strong>Server-side tools</strong> (HTML/CSS/JS Minifiers, CSS Inliner, URL Shortener, Code Beautifier) — Your
          input is sent securely over HTTPS to our server for processing using server-side libraries. Once the result is
          returned, the input data is immediately discarded from server memory. No data is stored, cached, or logged on
          our servers or any third-party service.
        </li>
      </ul>
      ...
      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>Google Analytics cookies</strong> — These cookies (including _ga, _gid, _gat) are used to distinguish
          users and throttle request rates. They are classified as first-party cookies and expire within 1&ndash;24
          months depending on the specific cookie. You can opt out of Google Analytics by installing the{' '}
          <a
      ...
      <p>
        We do <strong>not</strong> use cookies for advertising, personalization, social media tracking, or any purpose
        beyond basic analytics. You can control cookie preferences through your browser settings.
      </p>
      ...
      <p>
        We do <strong>not</strong> sell, rent, or share your personal information with third parties for marketing or
      ...
      <ul className="list-disc space-y-1 pl-6">
        <li>
          ...
          request timestamps, browser user agent) as part of their hosting infrastructure. Their privacy policy can be
          found at{' '}
          <a
      ...
      <p>
        ...
        <strong>juice</strong>, <strong>Prettier</strong>, and <strong>tinyurl</strong>. These libraries run on our own
        server infrastructure — your data is not sent to any third-party API or service for processing.
      </p>
      ...
      <ul className="list-disc space-y-1 pl-6">
        ...
        <li>
          <strong>Right to non-participation</strong> — Since we do not collect personal accounts or store tool inputs,
          there is no personal data profile associated with you that requires access, correction, or deletion.
        </li>
      </ul>
      ...
      <p>
        ...
        &quot;Last updated&quot; date. We encourage you to review this policy periodically for any changes. Continued
