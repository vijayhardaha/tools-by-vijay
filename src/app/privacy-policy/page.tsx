...
export default function PrivacyPolicyPage(): JSX.Element {
  return (
    <WithInfoPage slug="privacy-policy">
      <div className="space-y-6 text-base leading-relaxed text-gray-800">
        ...
        <ul className="list-disc space-y-1 pl-6">
          <li>
            ...
            location (country/city level). This data is collected via cookies and similar tracking technologies. Your IP
            address is anonymized before processing. Google Analytics helps us understand how visitors use the site so
            we can improve performance and user experience.
          </li>
          <li>
        ...
        <ul className="list-disc space-y-1 pl-6">
          <li>
            <strong>Client-side tools</strong> (Slug Generator, Character Counter, Password Checker, Text Case Changer,
            QR Code Generator, JSON Sorter, and most text utilities) — All processing happens entirely in your browser
            using JavaScript. Your data never leaves your device and is not transmitted to any server.
          </li>
          <li>
        ...
        <ul className="list-disc space-y-1 pl-6">
          ...
          <li>
            ...
            inputs, there is no personal data profile associated with you that requires access, correction, or deletion.
          </li>
        </ul>
