          ...
          <div className="space-y-6 text-base leading-relaxed text-gray-800">
            ...
            <ul className="list-disc space-y-1 pl-6">
              <li>
                ...
                location (country/city level). This data is collected via cookies and similar tracking technologies.
                Your IP address is anonymized before processing. Google Analytics helps us understand how visitors use
                the site so we can improve performance and user experience.
              </li>
              <li>
                <strong>Vercel Analytics</strong> — We use Vercel Analytics, a privacy-first analytics service provided
                by Vercel Inc. (our hosting provider). Vercel Analytics collects anonymized page view data for
                performance monitoring. It does not use cookies and does not collect personally identifiable
                information.
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>
                ...
                — Your input is sent securely over HTTPS to our server for processing using server-side libraries. Once
                the result is returned, the input data is immediately discarded from server memory. No data is stored,
                cached, or logged on our servers or any third-party service.
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-1 pl-6">
              <li>
                ...
                distinguish users and throttle request rates. They are classified as first-party cookies and expire
                within 1&ndash;24 months depending on the specific cookie. You can opt out of Google Analytics by
                installing the{' '}
                <a
            ...
            <ul className="list-disc space-y-1 pl-6">
              <li>
                <strong>Vercel Inc.</strong> — Our hosting provider. Vercel may collect standard server logs (IP
                address, request timestamps, browser user agent) as part of their hosting infrastructure. Their privacy
              ...
              <li>
                <strong>Google Analytics</strong> — Provides anonymized traffic analytics. Google&apos;s privacy policy
                is available at{' '}
                <a
            ...
            <p>
              ...
              <strong>juice</strong>, <strong>Prettier</strong>, and <strong>tinyurl</strong>. These libraries run on
              our own server infrastructure — your data is not sent to any third-party API or service for processing.
            </p>
            ...
            <ul className="list-disc space-y-1 pl-6">
              <li>
                <strong>Right to opt out</strong> — You can opt out of Google Analytics using the browser add-on
                mentioned above. You can also disable JavaScript in your browser, though this may affect tool
                functionality.
              </li>
              <li>
                <strong>Right to information</strong> — This Privacy Policy provides full transparency about what data
