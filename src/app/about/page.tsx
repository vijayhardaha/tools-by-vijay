    ...
    <PageLayout>
      ...
      <PageContent>
        <div className="space-y-6 text-base leading-relaxed text-gray-800">
          <p>
            Hello! I’m Vijay, a dedicated <strong>web developer</strong> and passionate <strong>vegan</strong> from
            India. I’ve always been fascinated by clean, efficient, and user-friendly web tools that make everyday tasks
            simpler for developers, content writers, and digital creators.
          </p>
          ...
          <p>
            That’s why I decided to build my own platform: <strong>Tools by Vijay</strong>. It started as a personal
          ...
          <p>
            My goal is to serve a broad audience - whether you’re a developer, writer, student, or anyone looking for
