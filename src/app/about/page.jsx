...
const About = () => {
  return (
    <PageLayout>
      <PageHeader
        title="About Me"
        description="Why I built this platform and what drives it"
      />
      <PageContent>
        <div className="space-y-4 text-base leading-relaxed">
          <p>
            ...
            of ads, slow to load, or track user data.
          </p>
          ...
          <p>
            Over time, I realized that other people like me — developers,
            content writers, students, or anyone working online — might find
            these tools useful too. So I decided to make this site public and
            open to everyone.
          </p>

          <p>
            I built this site using modern tech like Next.js and Tailwind CSS,
            with a focus on speed, accessibility, and simplicity. There are no
            trackers, no popups, and no distractions — just useful tools that
            work.
          </p>

          <p>
            I plan to keep adding more tools as I need them or get suggestions
            from others. If you have an idea for a tool, or want to say hello,
