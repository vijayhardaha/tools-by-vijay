...
import type { TextColor } from '@/components/text-story-maker/constants/textColors';
 ...
 * @param {keyof TextColor} [key] - The specific property to retrieve from the text color object (default is "text").
 *
 ...
 *
 * @param {StoryOptions} options - The options object containing style properties.
 *
 * @returns {Record<string, string | number>} The generated styles object.
 */
export function getContentStyles(options: StoryOptions): Record<string, string | number> {
