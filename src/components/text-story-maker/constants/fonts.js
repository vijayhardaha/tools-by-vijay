...
export const fonts = {
  ...
  crimson_text: { label: "Crimson Text", class: Crimson_Text.className },
  ...
  roboto_condensed: {
    ...
    class: Roboto_Condensed.className,
  },
  montserrat: { label: "Montserrat", class: Montserrat.className },
  libre_baskerville: {
  ...
  eb_garamond: { label: "EB Garamond", class: EB_Garamond.className },
  sacramento: { label: "Sacramento", class: Sacramento.className },
  architects_daughter: {
