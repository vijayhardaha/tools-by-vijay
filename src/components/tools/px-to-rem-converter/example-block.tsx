...
export function ExampleBlock({ onExample }: ExampleBlockProps): JSX.Element {
  return (
    <div className="flex flex-wrap gap-2">
      <Button variant="primary" onClick={() => onExample({ pxValue: '16', baseFontSize: 16 })}>
        Load Example 1
      </Button>
      <Button variant="primary" onClick={() => onExample({ pxValue: '32', baseFontSize: 16 })}>
        Load Example 2
      </Button>
      <Button variant="primary" onClick={() => onExample({ pxValue: '8', baseFontSize: 16 })}>
        Load Example 3
      </Button>
      <Button variant="primary" onClick={() => onExample({ pxValue: '28', baseFontSize: 14 })}>
        Load Example 4
      </Button>
      <Button variant="primary" onClick={() => onExample({ pxValue: '48', baseFontSize: 16 })}>
        Load Example 5
      </Button>
    </div>
  );
