  ...
  return (
    <div className="max-w-none space-y-8">
      <section>
        ...
        <p className="mb-4">
          The Duplicate Line Removal tool helps you clean up text by removing
          duplicate lines. It also provides options to sort the lines
          alphabetically, by ASCII values, or leave them unsorted. This tool is
          useful for text processing, data cleanup, and ensuring unique entries
          in lists.
        </p>
        <p className="mb-4">
          All processing happens directly in your browser – your data is never
      ...
      <section>
        ...
        <ol className="list-decimal space-y-2 pl-6">
          <li>
            <strong>Enter Your Text:</strong> Paste or type your text into the
            input area.
          </li>
          <li>
            ...
            <ul className="list-disc pt-2 pl-6">
              <li>
                <strong>Type of Sorting:</strong> Choose between no sorting,
                alphabetical sorting, or ASCII sorting.
              </li>
              <li>
                <strong>Reverse Sorting:</strong> Enable this option to reverse
                the sorting order (Z-A or 9-0).
              </li>
            </ul>
          </li>
          <li>
            <strong>Process Text:</strong> Click the “Process” button to remove
            duplicate lines and apply the selected sorting options.
          </li>
          <li>
            <strong>Copy Result:</strong> Copy the processed text to your
