 ...
 * @property {string} title - The display name of the tool
 ...
 * @property {string} subCategory - The sub-category label the tool belongs to (e.g. "Minify & Beautify")
 */
 ...
 * @type {Tool[]}
 *
 * Tools are grouped by category and ordered by sub-category, then by the
 * curated order defined in `updated-tools.md` (tools.md lists the prior order).
 */
const tools: Tool[] = [
  // ===== creative-generators =====
  {
  ...
  },
  {
    ...
    category: 'developer-suite',
    subCategory: 'Converters & Utilities',
  },
  {
    slug: 'json-sorter',
    title: 'JSON Sorter',
